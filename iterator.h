...
namespace tools {
	...
	protected:
		...
		typedef _iterator_traits<_Iterator>              base_type;
	...
	public:
		...
		self_type& operator+=(difference_type n) { return current += n; return *this; }
...
//		typedef typename _Iterator::value_type        value_type;
//		typedef typename _Iterator::iterator_category iterator_category;
//		typedef typename _Iterator::ptrdiff_t         difference_type;
//
//		_const_iterator() = default;
//		_const_iterator(const _Iterator& other) :
//
//	};
}
